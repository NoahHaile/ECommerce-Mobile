...
class SignIn extends StatelessWidget {
  double scrW = 0;
  double scrH = 0;
  TextEditingController emailPhoneNoTxtController = TextEditingController(text: "jane@example.com");
  TextEditingController passWordTxtContoller = TextEditingController(text: "password2");
        ...
        body: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                Color.fromARGB(255, 216, 218, 236),
